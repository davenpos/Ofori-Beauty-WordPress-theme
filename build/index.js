...
class MobileMenu {
  ...
  events() {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(window).on("resize", () => this.setVariables());
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on("click", e => {
      if (this.menuOpen && !jquery__WEBPACK_IMPORTED_MODULE_0___default()(e.target).closest('nav#headerMenu').length && !jquery__WEBPACK_IMPORTED_MODULE_0___default()(e.target).closest('div#wpadminbar').length && !jquery__WEBPACK_IMPORTED_MODULE_0___default()(e.target).is(this.menuButton)) {
        this.closeMobileMenu();
      }
    });
  }
  openMobileMenu() {
    if (jquery__WEBPACK_IMPORTED_MODULE_0___default()(window).scrollTop() > this.headerHeight) {
